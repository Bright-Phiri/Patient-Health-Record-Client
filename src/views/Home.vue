                  ...
                  <div class="card-header bg-secondary text-white" style="border-radius: 0">
                    <div class="row">
                      ...
                      <div class="col">
                        ...
                        <h5 class="text-center text-white" id="vital_signs">{{ vital_signs }}</h5>
                      </div>
                    </div>
                  </div>
                  <div class="card footer p-1" style="border-radius: 0">
                  ...
                  <div class="card-header bg-secondary text-white" style="border-radius: 0">
                    <div class="row">
                      ...
                      <div class="col">
                        ...
                        <h5 class="text-center text-white" id="providers">{{ providers }}</h5>
                      </div>
                    </div>
                  </div>
                  <div class="card footer p-1" style="border-radius: 0">
                    <router-link to="/viewpatients">View users / providers</router-link>
                  </div>
                </div>
              </div>
            </div>
