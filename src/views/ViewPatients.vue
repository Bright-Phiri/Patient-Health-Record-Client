              ...
              <form v-on:submit.prevent="addMedicalRecord" id="health-records-form">
                ...
                <div class="form-group">
                  ...
                  >
                    ...
                    <option value="A00-B99|Certain infectious and parasitic diseases">
                      Certain infectious
                      and
                      parasitic diseases
                    </option>
                    ...
                    <option value="E00-E89|Endocrine, nutritional and metabolic diseases">
                      Endocrine,
                      nutritional
                      and metabolic diseases
                    </option>
                    <option value="F01-F99|Mental, Behavioral and Neurodevelopmental disorders">
                      Mental,
                    ...
                    <option value="H60-H95|Diseases of the ear and mastoid process">
                      Diseases of the ear
                      and
                      mastoid process
                    </option>
                    ...
                    <option value="L00-L99|Diseases of the skin and subcutaneous tissue">
                      Diseases of the
                      skin
                    ...
                    <option value="O00-O9A|Pregnancy, childbirth and the puerperium">
                      Pregnancy,
                      childbirth and
                      the puerperium
                    </option>
                    <option value="P00-P96|Certain conditions originating in the perinatal period">
                      Certain
                    ...
                    >External causes of morbidity</option>
                    <option
            ...
            <div class="modal-body">
              ...
              <ul class="timeline">
                <li v-for="vital in vitals" :key="vital.id">
                  ...
                  <a class="float-end text-decoration-none">{{ vital.created_at.substr(0, 7) }}</a>
                  ...
                  <div class="card mt-2">
                    ...
                    <div class="card-body">
                      ...
                      <a
                        ...
                        :href="'https://www.icd10data.com/ICD10CM/Codes/' + vital.diagnosis.split('|').shift()"
                        target="_blank"
                      >View Diagnosis</a>
                    </div>
                  </div>
  ...
  methods: {
    ...
    addMedicalRecord(event) {
      if (!this.vital_signs.weight || !this.vital_signs.height || !this.vital_signs.diagnosis || !this.vital_signs.temp_reading) {
        ...
        let pHRsAPIEndpoint = `${sessionStorage.getItem("API_URL")}/${this.BASE_URL}/${this.vital_signs.patient_id}/vital_signs`;
        axios
    ...
    fetchHealthRecord(patient_id) {
      let pHRsAPIEndpoint = `${sessionStorage.getItem("API_URL")}/${this.BASE_URL}/${patient_id}/vital_signs/${patient_id}`;
      axios
        .get(pHRsAPIEndpoint, {
          headers: {
            "Authorization": `Bearer ${sessionStorage.getItem("Authorization")}`
        ...
        .then(response => {
          if (response.data.status === "error") {
            ...
            document.getElementById('medicalRecordsButton').click();
          }
        })
        .catch((error) => {
          console.log(error)
